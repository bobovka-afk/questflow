...
import { CheckinStreakMilestonesPanel } from '@widgets/checkin-streak/milestones-panel/CheckinStreakMilestonesPanel';
import { STREAK_LABEL } from '@entities/reward';
import { XP_DAILY_CHECKIN } from '@entities/reward';
