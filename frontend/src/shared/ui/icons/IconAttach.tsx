...
/** Atlaskit Attachment icon — same glyph as Trello card badges. */
export function IconAttach({ size = 16, className }: Props) {
  return (
    <svg
      width={size}
      height={size}
