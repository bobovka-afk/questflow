...
const gamification_cron_service_1 = require("./gamification-cron.service");
...
exports.GamificationModule = GamificationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [gamification_cron_service_1.GamificationCronService],
        exports: [gamification_cron_service_1.GamificationCronService],
    })
], GamificationModule);
