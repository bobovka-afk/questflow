...
exports.XP_REQUIRED_BY_LEVEL = exports.MAX_LEVEL = void 0;
exports.getRequiredXpForLevel = getRequiredXpForLevel;
exports.MAX_LEVEL = 100;
exports.XP_REQUIRED_BY_LEVEL = [
...
function getRequiredXpForLevel(level) {
    if (level <= 1)
        return exports.XP_REQUIRED_BY_LEVEL[1];
    if (level >= exports.MAX_LEVEL)
        return exports.XP_REQUIRED_BY_LEVEL[exports.MAX_LEVEL];
    return exports.XP_REQUIRED_BY_LEVEL[level];
}
//# sourceMappingURL=level-curve.js.map