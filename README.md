...
- Дневные и недельные квесты с прогрессом.
...
- `docs/gamification-agent-context.md`
- `docs/gamification-roadmap.md`
...
- Исполнители, дедлайны, переносы карточек, завершение, комментарии
